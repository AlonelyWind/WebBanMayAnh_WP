<?php
if(!class_exists('Zigcy_Baby_Welcome')) :

	class Zigcy_Baby_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					'getting_started' => esc_html__('Getting Started', 'zigcy-baby'),
					'actions_required' => esc_html__('Recommended Plugins', 'zigcy-baby'),
					'demo_import' => esc_html__('Import Demo', 'zigcy-baby'),
					'free_vs_pro' => esc_html__('Free Vs Pro', 'zigcy-baby'),
					'changelog' => esc_html__('ChangeLog', 'zigcy-baby'),
					'support' => esc_html__('Support', 'zigcy-baby'),
				);
			...
			public function welcome_admin_notice_display() {
				...
				if( is_admin() && ('themes.php' == $pagenow) ) {
					...
					<div class="updated zigcy-an notice notice-success is-dismissible">
						<h2><?php printf(__( 'Welcome!', 'zigcy-baby' )) ?></h2>
						<p class="about-desc"><?php esc_html_e( 'Thank you for installing Zigcy Baby. It is now installed and ready to use. Here are some useful links to get started: ', 'zigcy-baby' );  ?></p>
						<hr/>
							...
							<div class="zigcy-column col-demos">
								<div>
									<h3>
										...
										<?php printf(__( 'Starter site demos!', 'zigcy-baby' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'You\'ve  got 1 great starter sites (Demos) to start with. By using one of these starter sites you\'ll get a great guidance on how to use the theme to its fullest and also save time to make your website. ', 'zigcy-baby' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page#demo_import' )  ); ?></p>
								</div>
								<div>
									<div class="button-wrapper">
										<a class=" button button-primary button-hero install-now" href="<?php echo admin_url( 'themes.php?page=welcome-page#demo_import' ) ?>"><?php esc_html_e( 'ready to use starter sites.', 'zigcy-baby' ); ?></a>

										<?php printf( wp_kses_post( '<a class="options-page-btn button-secondary" href="%2$s">Or start setting up your theme now (without demo)!</a>', 'zigcy-baby' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page' )  ); ?>
									</div>
								</div>
							</div>
							<div class="zigcy-column col-doc">
								<div>
									<h3>
										...
										<?php printf(__( 'Documentation', 'zigcy-baby' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'How to use Zigcy Baby! Here we\'ve a full and detailed documentation that explains how to use  Zigcy Baby in its best. ', 'zigcy-baby' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page' )  ); ?></p>
									<a href="https://doc.accesspressthemes.com/zigcy-lite/" class=" button" ><span><?php esc_html_e( 'Full Documentation', 'zigcy-baby' ); ?></span></a>
									<a href="https://accesspressthemes.com/support/" class=" ti-return-dashboard  button button-secondary  install-now" ><span><?php esc_html_e( 'Contact Support', 'zigcy-baby' ); ?></span></a>
								</div>
							</div>
							</div>
						</div>
					...
					<div class="wrap about-wrap access-wrap">
						<div class="top-block-wrap">
							<div class="about-text">
								<h1><?php printf( esc_html__( 'Welcome to %1$s - Version %2$s', 'zigcy-baby' ), $this->theme_name, $this->theme_version ); ?></h1>
								<?php printf( esc_html__( 'The %s is full fledged Premium WordPress theme for companies. The theme comes with spectacular design and powerful features. It is a highly flexible theme that gives you full control to design and manage your dream website as per your wish.', 'zigcy-baby' ), $this->theme_name ); ?>
							</div>
									...
									<div class="welcome-section-wrapper is_loading">
										...
										<div class="notice-sidebar is_loading">
											<div class= "notice-sidebar-item">
												<h4><?php echo esc_html('Join in our social networks!','zigcy-baby') ?></h4>
												<p><?php echo esc_html__('Get connected, share your opinions and more via our social community: ', 'zigcy-baby'); ?></p>

												<p><a href="https://www.facebook.com/AccessPressThemes"><?php echo esc_html('Join our Facebook Group','zigcy-baby') ?></a><?php echo esc_html__(' -to receive updates, offers and more.', 'zigcy-baby'); ?></p>

												<p><a href="https://www.youtube.com/channel/UCzD8I1moKISXDjAVr8dIf-w"><?php echo esc_html('Subscribe our YouTube Channel','zigcy-baby') ?></a><?php echo esc_html__(' -for tutorials, videos and more.', 'zigcy-baby'); ?></p>

												<p><a href="https://twitter.com/apthemes"><?php echo esc_html('Follow us on Twitter','zigcy-baby') ?></a><?php echo esc_html__(' -to stay updated. ', 'zigcy-baby'); ?></p>
											</div>
											<div class= "notice-sidebar-item">
												<h4><?php echo esc_html('Rate us!','zigcy-baby') ?></h4>
												<p><?php echo esc_html__('Are you enjoying Zigcy Baby? We would love to hear your feedback!', 'zigcy-baby'); ?></p>
												<a href="https://wordpress.org/support/theme/zigcy-baby/reviews/#new-post"><?php echo esc_html('Write a review','zigcy-baby') ?></a>
						...
						public function plugin_installer_callback(){
							...
							if ( ! current_user_can('install_plugins') ) {
								wp_die( esc_html__( 'Sorry, you are not allowed to install plugins on this site.', 'zigcy-baby' ) );
							}
							...
							if (! wp_verify_nonce( $nonce, 'plugin_installer_nonce' )) {
								wp_die( esc_html__( 'Error - unable to verify nonce, please try again.', 'zigcy-baby') );
							}
						...
						public function plugin_activation_callback() {
							...
							if(file_exists($plugin_file)) {
								...
								echo esc_html__('Plugin Does not Exists' , 'zigcy-baby');
							}
