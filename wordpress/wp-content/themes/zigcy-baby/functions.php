...
if( ! function_exists('zigcy_lite_widget_template_cus')){
    function zigcy_lite_widget_template_cus($wp_customize){

	$wp_customize->remove_section( 'zigcy_lite_header_layouts' );

    }

}

add_action('customize_register','zigcy_lite_widget_template_cus',11);
